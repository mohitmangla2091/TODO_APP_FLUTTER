...
class AuthScreen extends StatelessWidget {
  static const routeName = AUTH_ECREEN_ROUTE;
...
class _AuthCardState extends State<AuthCard>
  ...
  final _passwordController = TextEditingController(text: USER_PASSWORD);
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      var errorMessage = ERROR_AUTHENTICATION_FAILED;
      _showErrorDialog(errorMessage);
    } catch (error) {
      const errorMessage = ERROR_AUTH_FAILED_MESSAGE;
      _showErrorDialog(errorMessage);
    }
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                ...
                TextFormField(
                  decoration: InputDecoration(labelText: PASSWORD_CAMELCASE),
                  obscureText: true,
                  ...
                  child: FadeTransition(
                    ...
                    child: SlideTransition(
                      ...
                      child: TextFormField(
                        ...
                        decoration:
                            InputDecoration(labelText: CONFIRM_PASSWORD),
                        obscureText: true,
                ...
                if (_isLoading)
                  ...
                  RaisedButton(
                    child:
                        Text(_authMode == AuthMode.Login ? SIGN_IN : SIGN_UP),
                    onPressed: _submit,
                    shape: RoundedRectangleBorder(
